            ...
            <div class="p-4">
                <form action="{{ route('departments.store') }}" method="POST">
                    ...
                    <div id="departnamefield" class="hidden mb-4">
                        ...
                        <input type="text" name="departname" id="departname" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" nullable>
                    </div>
                    ...
                    <div id="clasnamefield" class="hidden mb-4">
                        <label for="clasname" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Grade</label>
                    ...
                    <!-- Drop Down -->
                    <div>
                        <select id="department_id" name="department_id" class="mt-1 block w-full rounded-lg border-gray-300 p-2 dark:bg-gray-600 dark:border-gray-500 dark:text-white" nullable>
