        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    ...
                    <div class="mt-1 truncate text-sm font-medium leading-none text-gray-400">tom@example.com</div>
                </div>
                <button @click="isOpen = !isOpen" class="ml-auto inline-flex rounded-full p-1 text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                    <span class="sr-only">Open user menu</span>
                    <svg class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 15.5c-3.125 0-5.5-2.375-5.5-5.5S8.875 4.5 12 4.5 17.5 6.875 17.5 10 15.125 15.5 12 15.5zm0-6c-1.375 0-2.5 1.125-2.5 2.5S10.625 14.5 12 14.5 14.5 13.375 14.5 12 13.375 9.5 12 9.5z" />
                    </svg>
                </button>
            </div>
