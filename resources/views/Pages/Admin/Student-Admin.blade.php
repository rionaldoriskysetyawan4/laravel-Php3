<x-layout-admin>
            ...
            @foreach ($students as $student)
                <tr class="border-b dark:border-gray-700">
                    ...
                    <td class="px-4 py-3 flex items-center justify-end">
                        <button id="apple-imac-20-dropdown-button" data-dropdown-toggle="menu-{{ $student->id }}"
    ...
    //tambahkan
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Ambil semua tombol yang memiliki data-modal-toggle="createModal"
        ...
        // Open the modal when the "Tambahkan" button is clicked
